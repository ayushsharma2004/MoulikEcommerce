        ...
        <Layout title={'Login - Ecommerce Website'}>
            <div className="loginseller_container">
                <div className="log_title">
                    <h2>Sign in with Seller's Account</h2>
                </div>
                ...
                <div className="divider-container">
                    ...
                    <span className="divider-text">Buying as user?</span>
                    <div className="sellerline"></div>
                </div>
                <div className='signin_seller'>
                    <button className="seller_text" onClick={toUser}>Sign in with user's account</button>
